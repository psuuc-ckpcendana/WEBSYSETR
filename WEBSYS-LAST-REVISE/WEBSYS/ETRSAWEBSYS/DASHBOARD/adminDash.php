            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/WEBSYS-LAST-REVISE/WEBSYS/ETRSAWEBSYS/testimonials/testimonials.php">Manage Testimonials</a>
                    </div>
                </div>
            </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-5">
                            <div class="card shadow mb-4">
                                ...
                                <br>
                                <!--SEARCH-->
                                <div class="container"><input type="text" class="form-control" name="" id="live_search" autocomplete="off" placeholder="search events..."></div>
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <br>
                                    <button type="submit" id="btn" class="btn btn-primary">Show Approved Events</button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div class="show-funds-details">
                                        <?php
                                        $showsql = "SELECT * FROM transactions ORDER BY id DESC LIMIT 2";

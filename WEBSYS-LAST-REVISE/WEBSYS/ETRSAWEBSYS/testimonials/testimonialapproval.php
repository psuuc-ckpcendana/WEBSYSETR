...
<head>
  ...
  <title>Testimonial Approval</title>
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="wrap">
          <div class="container">
          <a href="testimonials.php">Go Back to Testimonials</a>
            <?php
            if (isset($_GET['id'])) {
              include 'conn.php';
            ...
            ?>
                  <div class='p-2 mb-4 bg-body-tertiary rounded-3'>
                    ...
                    <h1 class='display-6 fw-bold mb-4'><b>Testimonial Details</b></h1>
                      <div class='row'>
                        <div class='col-md-6'>
                          <img class='p-5 img-fluid' src='img/pexels-markus-winkler-18512803.jpg' alt='Thumbnail Image' height='500' width='500' />
                        </div>
                        <div class='col-md-6'>
                          <p class='fs-5'><b>Name:</b> <?php echo htmlspecialchars($row['name']); ?></p>
                          <p class='fs-5'><b>Message:</b> <?php echo htmlspecialchars($row['message']); ?></p>
                          <p class='fs-5'><b>Date posted:</b> <?php echo htmlspecialchars($row['posted']); ?></p>
                          <form action='update.php' method='post' id="form1">
                            <input type='hidden' name='id' value='<?php echo $id; ?>' id="t_id">
                            <button class='btn btn-success btn-lg mt-3 ms-2' type='submit' name='approved' id="approve" value="approved">
                          ...
                          <input type='hidden' name='id' value='<?php echo $id; ?>' id="t_id">
                          <button class='btn btn-danger btn-lg mt-3 ms-2' type='submit' name='removed' id="remove" value="removed">
            ...
            <?php
                ...
                echo "<center><p>Error preparing statement.</p></center>";
              }
